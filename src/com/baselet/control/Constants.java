...
public abstract class Constants {
	...
	public static class Program {
		...
		public static void init(ProgramName name, String version) {
			...
			if (Program.PROGRAM_NAME == ProgramName.UMLET) EXTENSION = "xml";
			else EXTENSION = "pxf";
...
//	}
	...
	public static String TITLE_CHOOSE = "Seleccione la carpea donde crear el projecto";
	public static String TITLE_ERROR_OPEN = "Error Abrir";
	public static String TITLE_ERROR_CREATE = "Error crear";
	public static String MESSAGE_ERROR_OPEN  = " Error: No se pudo abrir el projecto";
	public static String MESSAGE_ERROR_CREATE = " Error: No se pudo crear el projecto";
	public static String NAME_PROJECT = "Nombre Projecto";
	public static String MESSAGE_PROJECT = "Ingrese el nombre del Projecto:\n";
	public static final String NAME_DIAGRAM = "Nombre Diagrama";
	public static final String MESSAGE_DIAGRAM = "Ingrese el nombre del Diagrama:\n";
